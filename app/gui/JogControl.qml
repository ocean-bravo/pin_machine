...
Item {
    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            Sp {} Sp {} Sp {} Sp {} MyButton { text: qsTr("+50");  onClicked: { jog("Y", 50,  xyFeedRate.value)} } Sp {} Sp {} Sp {} Sp {} Nsp {} Sp {}
            Sp {} Sp {} Sp {} Sp {} MyButton { text: qsTr("+10");  onClicked: { jog("Y", 10,  xyFeedRate.value)} } Sp {} Sp {} Sp {} Sp {} Nsp {} MyButtonZ { text: qsTr("+1");    onClicked: { jog("Z", 1,    zFeedRate.value)} }
            Sp {} Sp {} Sp {} Sp {} MyButton { text: qsTr("+1");   onClicked: { jog("Y", 1,   xyFeedRate.value)} } Sp {} Sp {} Sp {} Sp {} Nsp {} MyButtonZ { text: qsTr("+0.1");  onClicked: { jog("Z", 0.1,  zFeedRate.value)} }
            Sp {} Sp {} Sp {} Sp {} MyButton { text: qsTr("+0.1"); onClicked: { jog("Y", 0.1, xyFeedRate.value)} } Sp {} Sp {} Sp {} Sp {} Nsp {} MyButtonZ { text: qsTr("+0.01"); onClicked: { jog("Z", 0.01, zFeedRate.value)} }


            MyButton { text: qsTr("-50");  onClicked: { jog("X", -50,  xyFeedRate.value)} }
