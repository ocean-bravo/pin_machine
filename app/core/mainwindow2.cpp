...
void MainWindow2::logMessage(uint32_t /*level*/, const char */*message*/)
{

}

void MainWindow2::update(QImage img, QString frameInfo)
{
    ui->frameDisplay->setPixmap(QPixmap::fromImage(img));
    ui->statusBar->showMessage(frameInfo);
}

void MainWindow2::updateLogMessages()
{

}

void MainWindow2::changeCamera()
{
